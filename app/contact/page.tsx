...
const Contact = () => {
  return (
    <main className="flex w-full items-center justify-center px-5 sm:px-10 md:mt-10">
      <section className="max-w-screen flex flex-col md:max-w-screen-xl md:flex-row md:gap-10">
        <div className="flex h-full w-full flex-col gap-3 md:w-1/2 md:justify-center">
          <div className="relative">
            ...
            <div className="flex flex-col">
              <p className="w-full font-montserrat text-lg font-normal text-[#282828] sm:font-light lg:max-w-[50ch]">
                Om du vill komma i kontakt med mig är du välkommen att höra av
                dig via kontaktformuläret.
              </p>
              <p className="mb-5 mt-3 w-full font-montserrat text-lg font-normal text-[#282828] sm:font-light lg:max-w-[50ch]">
                Följ mig gärna på{" "}
            ...
            <BlobGradient
              color="bg-[#78A25D]"
              className="absolute bottom-0 right-0 z-[-1] opacity-30 sm:opacity-40 md:right-0 md:hidden lg:right-0 2xl:right-52"
            />
          </div>
